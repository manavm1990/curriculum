...
# Homework 1-1: MD and GitHub Introduction
...
Here's a silent video of me doing something **similar** to what you are being asked to do. Note that my environment is a bit different, and you will see that some AI 🤖 generation happening. You don't need all of that yet. More importantly, you see me create the MD file and start writing Markdown. You'll notice that I get realtime warnings from VS Code extensions about things that may not be quite right.

<div class="sp-embed-player" data-id="cZj3bOV9sNG">
<script src="https://go.screenpal.com/player/appearance/cZj3bOV9sNG"></script>
<iframe width="100%" height="100%" style={{border: "0", width: "100%",
height: "100%"}}
scrolling="no"
src="https://go.screenpal.com/player/cZj3bOV9sNG?width=100%&height=100%&ff=1" allowfullscreen="true"></iframe></div>
